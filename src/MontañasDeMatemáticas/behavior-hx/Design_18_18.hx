...
class Design_18_18 extends ActorScript
{
	...
	override public function init()
	{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				if(!(Engine.engine.getGameAttribute("Sound On")))
				{
					g.strokeSize = Std.int(5);
					g.strokeColor = Utils.getColorRGB(102,0,51);
					g.drawLine(5, ((actor.getHeight()) - 5), ((actor.getWidth()) - 5), 5);
				}
			}
		});
